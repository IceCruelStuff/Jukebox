export class Vector3 {
    ...
    static readonly SIDE_DOWN: number = 0;
    static readonly SIDE_UP: number = 1;
    static readonly SIDE_NORTH: number = 2;
    static readonly SIDE_SOUTH: number = 3;
    static readonly SIDE_WEST: number = 4;
    static readonly SIDE_EAST: number = 5;
